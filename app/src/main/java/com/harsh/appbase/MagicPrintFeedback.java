...
public class MagicPrintFeedback extends AppCompatActivity implements View.OnClickListener {
        ...
        if (withInfo) {
            ...
            deviceInfo.setSpan(new ClickableSpan() {
                ...
                public void onClick(View widget) {
                    new AlertDialog.Builder(MagicPrintFeedback.this)
                            .setTitle(R.string.info_fedback_legal_system_info)
                            .setMessage(MagicPrintFeedback.this.deviceInfo)
            ...
            systemLog.setSpan(new ClickableSpan() {
                ...
                public void onClick(View widget) {
                    new AlertDialog.Builder(MagicPrintFeedback.this)
                            ...
                            .setMessage(MagicPrintFeedback.this.LOG_TO_STRING)
                            .setPositiveButton(R.string.Ok, new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog, int which) {
                                    dialog.dismiss();
                                }
    ...
    public void sendEmail(String body) {
        ...
        if (realPath != null) {
            Uri uri = Uri.parse("content://" + realPath);
            uris.add(uri);
        }
    ...
    private Uri createFileFromString(String text, String name) {
        ...
        return FileProvider.getUriForFile(MagicPrintFeedback.this, BuildConfig.APPLICATION_ID + ".provider",file);
    }
